        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <a href="/" class="flex items-center space-x-3 group">
                    <img src="/logo-prime-facility-white.png" alt="Prime Facility Services Group" class="h-12 w-auto transition-transform duration-300 group-hover:scale-105">
                </a>
        ...
        <div class="mobile-menu-content fixed right-0 top-0 h-full w-80 bg-white shadow-2xl">
            <div class="p-6 border-b border-gray-100">
                <div class="flex justify-between items-center">
                    <img src="/logo-prime-facility-white.png" alt="Prime Facility Services Group" class="h-10 w-auto" style="filter: brightness(0) saturate(100%);">
